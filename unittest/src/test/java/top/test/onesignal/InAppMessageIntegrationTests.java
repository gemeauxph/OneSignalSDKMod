...
import static top.oneconnectapi.onesignal.OneSignalPackagePrivateHelper.dismissCurrentMessage;
...
public class InAppMessageIntegrationTests {
    ...
    public void testDisableInAppMessagingPreventsMessageDisplay() throws Exception {
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal testMessage = InAppMessagingHelpers.buildTestMessageWithSingleTrigger(OSTrigger.OSTriggerKind.CUSTOM, "test_key", OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.EQUAL_TO.toString(), 3);

        setMockRegistrationResponseWithMessages(new ArrayList<OneSignalPackagePrivateHelper.OSTestInAppMessageInternal>() {{
            add(testMessage);
        }});
    ...
    public void testMessagesDoNotDisplayPastEndTime() throws Exception {
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message = InAppMessagingHelpers.buildTestMessageWithEndTime(OSTrigger.OSTriggerKind.CUSTOM, "test_key", OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.EQUAL_TO.toString(), 3, true);
        setMockRegistrationResponseWithMessages(new ArrayList<OneSignalPackagePrivateHelper.OSTestInAppMessageInternal>() {{
            add(message);
        }});
    ...
    public void testMessagesDoDisplayBeforeEndTime() throws Exception {
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message = InAppMessagingHelpers.buildTestMessageWithEndTime(OSTrigger.OSTriggerKind.CUSTOM, "test_key", OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.EQUAL_TO.toString(), 3, false);
        setMockRegistrationResponseWithMessages(new ArrayList<OneSignalPackagePrivateHelper.OSTestInAppMessageInternal>() {{
            add(message);
        }});
    ...
    private void nextResponseMultiplePendingMessages() throws JSONException {
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal testFirstMessage = InAppMessagingHelpers.buildTestMessageWithSingleTrigger(OSTrigger.OSTriggerKind.CUSTOM, "test_1", OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.EQUAL_TO.toString(), 3);
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal testSecondMessage = InAppMessagingHelpers.buildTestMessageWithSingleTrigger(OSTrigger.OSTriggerKind.CUSTOM, "test_2", OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.EQUAL_TO.toString(), 2);
    ...
    public void testTimedMessageIsDisplayedOncePerSession() throws Exception {
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message = InAppMessagingHelpers.buildTestMessageWithSingleTriggerAndRedisplay(
                OSTrigger.OSTriggerKind.SESSION_TIME,
                null,
                OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.GREATER_THAN.toString(),
                0.05,
                10,
                0);
    ...
    public void testAfterLastInAppTimeIsDisplayedOncePerSession() throws Exception {
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message1 = InAppMessagingHelpers.buildTestMessageWithSingleTriggerAndRedisplay(
                OSTrigger.OSTriggerKind.SESSION_TIME,
                null,
                OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.GREATER_THAN.toString(),
                0.05,
        ...
        ArrayList<ArrayList<OneSignalPackagePrivateHelper.OSTestTrigger>> triggers2 = new ArrayList<ArrayList<OneSignalPackagePrivateHelper.OSTestTrigger>>() {{
            add(new ArrayList<OneSignalPackagePrivateHelper.OSTestTrigger>() {{
                add(InAppMessagingHelpers.buildTrigger(OSTrigger.OSTriggerKind.SESSION_TIME, null, OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.GREATER_THAN.toString(), 0.1));
                add(InAppMessagingHelpers.buildTrigger(OSTrigger.OSTriggerKind.TIME_SINCE_LAST_IN_APP, null, OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.GREATER_THAN.toString(), 0.05));
            }});
        }};
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message2 = InAppMessagingHelpers.buildTestMessageWithMultipleTriggersAndRedisplay(triggers2, 10, 0);
    ...
    public void testTimedMessageDisplayedAfterAllTriggersValid() throws Exception {
        ArrayList<ArrayList<OneSignalPackagePrivateHelper.OSTestTrigger>> triggers = new ArrayList<ArrayList<OneSignalPackagePrivateHelper.OSTestTrigger>>() {{
            add(new ArrayList<OneSignalPackagePrivateHelper.OSTestTrigger>() {{
                add(InAppMessagingHelpers.buildTrigger(OSTrigger.OSTriggerKind.CUSTOM, "test_key", OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.EQUAL_TO.toString(), "squirrel"));
                add(InAppMessagingHelpers.buildTrigger(OSTrigger.OSTriggerKind.SESSION_TIME, null, OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.GREATER_THAN.toString(), 0.01));
            }});
        }};

        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message = InAppMessagingHelpers.buildTestMessageWithMultipleTriggers(triggers);
    ...
    public void testMessageDisplayedAfterAddTriggerEqualWithStringVsNumber() throws Exception {
        ...
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message =
                InAppMessagingHelpers.buildTestMessageWithSingleTrigger(OSTrigger.OSTriggerKind.CUSTOM, "test", OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.EQUAL_TO.toString(), "5");
    ...
    public void testMessageDisplayedAfterAddTriggerEqualWithStringVsNumberFloat() throws Exception {
        // Set IAM with EQUAL trigger with number value as string
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message =
                InAppMessagingHelpers.buildTestMessageWithSingleTrigger(OSTrigger.OSTriggerKind.CUSTOM, "test", OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.EQUAL_TO.toString(), "5.5");
    ...
    public void testInAppMessageOnlyReceivesClickIdOnce() throws Exception {
        ...
        // 2. Create an IAM
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message = InAppMessagingHelpers.buildTestMessageWithSingleTrigger(
                OSTrigger.OSTriggerKind.SESSION_TIME,
                null,
        ...
        Set<String> testClickedMessages = OneSignalPackagePrivateHelper.TestOneSignalPrefs.getStringSet(
           OneSignalPackagePrivateHelper.TestOneSignalPrefs.PREFS_ONESIGNAL,
           OneSignalPackagePrivateHelper.TestOneSignalPrefs.PREFS_OS_CLICKED_CLICK_IDS_IAMS,
           null
        );
    ...
    public void testOnIAMActionSendsOutcome_usingOutcomesV2() throws Exception {
        ...
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message = InAppMessagingHelpers.buildTestMessageWithSingleTrigger(
                OSTrigger.OSTriggerKind.CUSTOM, "test_1", OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.EQUAL_TO.toString(), 2);
    ...
    public void testInAppMessageOnlyReceivesOneImpression() throws Exception {
        ...
        Set<String> testImpressionedMessages = OneSignalPackagePrivateHelper.TestOneSignalPrefs.getStringSet(
                OneSignalPackagePrivateHelper.TestOneSignalPrefs.PREFS_ONESIGNAL,
                OneSignalPackagePrivateHelper.TestOneSignalPrefs.PREFS_OS_IMPRESSIONED_IAMS,
                null
        );
    ...
    public void testInAppMessageDisplayMultipleTimes() throws Exception {
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message = InAppMessagingHelpers.buildTestMessageWithSingleTriggerAndRedisplay(
                OSTrigger.OSTriggerKind.CUSTOM, "test_1", OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.EQUAL_TO.toString(), 2, LIMIT, DELAY);
    ...
    public void testInAppMessageDisplayMultipleTimes_sessionDurationTrigger() throws Exception {
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message = InAppMessagingHelpers.buildTestMessageWithSingleTriggerAndRedisplay(OSTrigger.OSTriggerKind.SESSION_TIME, "",
                OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.GREATER_THAN.toString(), 0.05, LIMIT, DELAY);
    ...
    public void testInAppMessageDisplayMultipleTimes_NoTriggers() throws Exception {
        ...
        // Create an IAM
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message = InAppMessagingHelpers.buildTestMessageWitRedisplay(LIMIT, DELAY);
        ...
        OneSignalPackagePrivateHelper.TestOneSignalPrefs.saveStringSet(
                OneSignalPackagePrivateHelper.TestOneSignalPrefs.PREFS_ONESIGNAL,
                OneSignalPackagePrivateHelper.TestOneSignalPrefs.PREFS_OS_DISMISSED_IAMS,
    ...
    public void testInAppMessageDisplayMultipleTimes_RemoveTrigger() throws Exception {
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message = InAppMessagingHelpers.buildTestMessageWithSingleTriggerAndRedisplay(
                OSTrigger.OSTriggerKind.CUSTOM, "test_1", OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.NOT_EXISTS.toString(), 2, LIMIT, DELAY);
    ...
    public void testInAppMessageNoDisplayMultipleTimes_Limit() throws Exception {
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message = InAppMessagingHelpers.buildTestMessageWithSingleTriggerAndRedisplay(
                OSTrigger.OSTriggerKind.CUSTOM, "test_1", OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.EQUAL_TO.toString(), 2, 1, DELAY);
    ...
    public void testInAppMessageMultipleRedisplayReceivesClickId() throws Exception {
        ...
        // Verify clickId was persisted locally
        Set<String> secondRestClickedMessages = OneSignalPackagePrivateHelper.TestOneSignalPrefs.getStringSet(
                OneSignalPackagePrivateHelper.TestOneSignalPrefs.PREFS_ONESIGNAL,
                OneSignalPackagePrivateHelper.TestOneSignalPrefs.PREFS_OS_CLICKED_CLICK_IDS_IAMS,
                null
        );
    ...
    public void testCachedIAMSharedPreferenceAndSQL_cleanedAfterSixMonths() throws Exception {
        ...
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal iam1 = InAppMessagingHelpers.buildTestMessage(null);
        ...
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal iam2 = InAppMessagingHelpers.buildTestMessage(null);
        ...
        Set<String> testDismissedMessages = OneSignalPackagePrivateHelper.TestOneSignalPrefs.getStringSet(
                OneSignalPackagePrivateHelper.TestOneSignalPrefs.PREFS_ONESIGNAL,
                OneSignalPackagePrivateHelper.TestOneSignalPrefs.PREFS_OS_DISMISSED_IAMS,
                null);
        ...
        Set<String> testClickedClickIds = OneSignalPackagePrivateHelper.TestOneSignalPrefs.getStringSet(
                OneSignalPackagePrivateHelper.TestOneSignalPrefs.PREFS_ONESIGNAL,
                OneSignalPackagePrivateHelper.TestOneSignalPrefs.PREFS_OS_CLICKED_CLICK_IDS_IAMS,
                null);
        ...
        List<OneSignalPackagePrivateHelper.OSTestInAppMessageInternal> savedInAppMessagesAfterInit = TestHelpers.getAllInAppMessages(dbHelper);
    ...
    public void testInAppMessageRedisplayCacheCleaning() throws Exception {
        ...
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal inAppMessage = InAppMessagingHelpers.buildTestMessageWithSingleTriggerAndRedisplay(
                OSTrigger.OSTriggerKind.CUSTOM, "test_saved", OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.EQUAL_TO.toString(), 2, LIMIT, DELAY);
        ...
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message1 = InAppMessagingHelpers.buildTestMessageWithSingleTriggerAndRedisplay(
                OSTrigger.OSTriggerKind.CUSTOM, "test_1", OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.EQUAL_TO.toString(), 2, LIMIT, DELAY);
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message2 = InAppMessagingHelpers.buildTestMessageWithSingleTriggerAndRedisplay(
                OSTrigger.OSTriggerKind.CUSTOM, "test_2", OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.EQUAL_TO.toString(), 2, LIMIT, DELAY);
    ...
    public void testLiquidIAMDisplayWaitsForGetTags() throws Exception {
        final OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message = InAppMessagingHelpers.buildTestMessageWithSingleTriggerAndLiquid(
                OSTrigger.OSTriggerKind.CUSTOM, "test_1", OneSignalPackagePrivateHelper.OSTestTrigger.OSTriggerOperator.EQUAL_TO.toString(), 2);
    ...
    public void testInAppMessageInternalToJSONObject_messageId() throws Exception {
        ...
        OneSignalPackagePrivateHelper.OSTestInAppMessageInternal iam = InAppMessagingHelpers.buildTestMessage(null);
    ...
    private void setMockRegistrationResponseWithMessages(ArrayList<OneSignalPackagePrivateHelper.OSTestInAppMessageInternal> messages) throws JSONException {
        final JSONArray jsonMessages = new JSONArray();

        for (OneSignalPackagePrivateHelper.OSTestInAppMessageInternal message : messages)
