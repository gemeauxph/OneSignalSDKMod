...
import top.oneconnectapi.onesignal.ShadowOneSignalRestClientWithMockConnection;
...
import static top.oneconnectapi.onesignal.OneSignalPackagePrivateHelper.OneSignal_OSTaskController_ShutdownNow;
...
public class TestHelpers {
   ...
   static void beforeTestInitAndCleanup() throws Exception {
      OneSignalPackagePrivateHelper.TestOneSignalPrefs.initializePool();
   ...
   public static void afterTestCleanup() throws Exception {
      try {
         OneSignalPackagePrivateHelper.OneSignal_OSTaskController_ShutdownNow();
         stopAllOSThreads();
      } catch (Exception e) {
         e.printStackTrace();
      }
   ...
   static void flushBufferedSharedPrefs() {
      OneSignalPackagePrivateHelper.TestOneSignalPrefs.WritePrefHandlerThread handlerThread = OneSignalPackagePrivateHelper.TestOneSignalPrefs.prefsHandler;
   ...
   synchronized static void saveIAM(OneSignalPackagePrivateHelper.OSTestInAppMessageInternal inAppMessage, OneSignalDb db) {
   ...
   synchronized static List<OneSignalPackagePrivateHelper.OSTestInAppMessageInternal> getAllInAppMessages(OneSignalDb db) throws JSONException {
      Cursor cursor = db.query(
      ...
      List<OneSignalPackagePrivateHelper.OSTestInAppMessageInternal> iams = new ArrayList<>();
      if (cursor.moveToFirst())
         do {
            ...
            OneSignalPackagePrivateHelper.OSTestInAppMessageInternal inAppMessage = new OneSignalPackagePrivateHelper.OSTestInAppMessageInternal(messageId, displayQuantity, lastDisplay, displayed, clickIdsSet);
   ...
   public static void startRemoteNotificationReceivedHandlerService(String servicePath) {
      OneSignalShadowPackageManager.addManifestMetaData("top.oneconnectapi.onesignal.NotificationServiceExtension", servicePath);
   }
}
