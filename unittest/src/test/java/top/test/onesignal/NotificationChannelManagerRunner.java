...
import static top.oneconnectapi.onesignal.OneSignalPackagePrivateHelper.NotificationChannelManager_createNotificationChannel;
import static top.oneconnectapi.onesignal.OneSignalPackagePrivateHelper.NotificationChannelManager_processChannelList;
...
public class NotificationChannelManagerRunner {
   ...
   public void createNotificationChannelShouldReturnDefaultChannelWithEmptyPayload() {
      ...
      String ret = OneSignalPackagePrivateHelper.NotificationChannelManager_createNotificationChannel(blankActivity, payload);
   ...
   public void useOtherChannelWhenItIsAvailable() throws Exception {
      ...
      ret = OneSignalPackagePrivateHelper.NotificationChannelManager_createNotificationChannel(blankActivity, payload);
   ...
   public void processPayloadWithOutChannelList() {
      ...
      OneSignalPackagePrivateHelper.NotificationChannelManager_processChannelList(blankActivity, null);
   ...
   public void processPayloadCreatingNewChannel() throws Exception {
      ...
      OneSignalPackagePrivateHelper.NotificationChannelManager_processChannelList(blankActivity, channelList);
   ...
   public void processPayloadDeletingOldChannel() throws Exception {
      OneSignalPackagePrivateHelper.NotificationChannelManager_processChannelList(blankActivity, createBasicChannelListPayload().optJSONArray("chnl_lst"));
   ...
   public void processChannelListWithMultiLanguage() throws Exception {
      ...
      OneSignalPackagePrivateHelper.NotificationChannelManager_processChannelList(blankActivity, payload.optJSONArray("chnl_lst"));
   ...
   public void handleInvalidColorCode() throws Exception {
      ...
      OneSignalPackagePrivateHelper.NotificationChannelManager_createNotificationChannel(blankActivity, payload);
