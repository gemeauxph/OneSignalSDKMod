...
jstring Java_top_oneconnectapi_app_core_NativeUtils_getJNIAPI(JNIEnv *env, jclass jo)
{

    return (*env)->NewStringUTF(env, TARGET_ARCH_ABI);
}

jstring Java_top_oneconnectapi_app_core_NativeUtils_getOpenVPN2GitVersion(JNIEnv *env, jclass jo)
{

  return (*env)->NewStringUTF(env, OPENVPN2_GIT_REVISION);
}

jstring Java_top_oneconnectapi_app_core_NativeUtils_getOpenVPN3GitVersion(JNIEnv *env, jclass jo)
{
