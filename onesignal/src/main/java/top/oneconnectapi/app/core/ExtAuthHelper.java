...
import top.oneconnectapi.app.api.ExternalCertificateProvider;
...
public class ExtAuthHelper {
    ...
    public static final String ACTION_CERT_CONFIGURATION = "top.oneconnectapi.app.api.ExternalCertificateConfiguration";
    public static final String ACTION_CERT_PROVIDER = "top.oneconnectapi.app.api.ExternalCertificateProvider";

    public static final String EXTRA_ALIAS = "top.oneconnectapi.app.api.KEY_ALIAS";
    public static final String EXTRA_DESCRIPTION = "top.oneconnectapi.app.api.KEY_DESCRIPTION";
