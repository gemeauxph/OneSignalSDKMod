...
import top.oneconnectapi.app.DisconnectVPNActivity;
...
import top.oneconnectapi.app.utils.TotalTraffic;

import static top.oneconnectapi.app.core.NetworkSpace.IpAddress;
...
public class OpenVPNService extends VpnService implements VpnStatus.StateListener, Callback, VpnStatus.ByteCountListener, IOpenVPNServiceInternal {
    ...
    public static final String START_SERVICE = "top.oneconnectapi.app.START_SERVICE";
    public static final String START_SERVICE_STICKY = "top.oneconnectapi.app.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "top.oneconnectapi.app.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "top.oneconnectapi.app.DISCONNECT_VPN";
    ...
    private static final String PAUSE_VPN = "top.oneconnectapi.app.PAUSE_VPN";
    private static final String RESUME_VPN = "top.oneconnectapi.onesignal.RESUME_VPN";

    public static final String EXTRA_CHALLENGE_TXT = "top.oneconnectapi.app.core.CR_TEXT_CHALLENGE";
    public static final String EXTRA_CHALLENGE_OPENURL = "top.oneconnectapi.app.core.OPENURL_CHALLENGE";
    ...
    synchronized void unregisterDeviceStateReceiver() {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: top.oneconnectapi.app.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("com.oneconnectapi.app.core.OpenVPNThreadv3");
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("top.oneconnectapi.app.VPN_STATUS");
