...
import top.oneconnectapi.onesignal.influence.domain.OSInfluenceType.Companion.fromString
import top.oneconnectapi.onesignal.outcomes.OSOutcomeConstants
import top.oneconnectapi.onesignal.outcomes.domain.OSCachedUniqueOutcome
import top.oneconnectapi.onesignal.outcomes.domain.OSOutcomeEventParams
import top.oneconnectapi.onesignal.outcomes.domain.OSOutcomeSource
import top.oneconnectapi.onesignal.outcomes.domain.OSOutcomeSourceBody
...
internal class OSOutcomeEventsCache(
    ...
    private fun getNotificationInfluenceSource(
        notificationInfluenceType: OSInfluenceType,
    ...
    private fun getIAMInfluenceSource(
        iamInfluenceType: OSInfluenceType,
        directSourceBody: OSOutcomeSourceBody,
        indirectSourceBody: OSOutcomeSourceBody,
        iamIds: String,
