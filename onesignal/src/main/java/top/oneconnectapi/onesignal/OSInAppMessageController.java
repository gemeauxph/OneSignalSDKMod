...
import top.oneconnectapi.onesignal.OSDynamicTriggerController.OSDynamicTriggerControllerObserver;
...
import static top.oneconnectapi.onesignal.OSInAppMessageRepository.IAM_DATA_RESPONSE_RETRY_KEY;
        ...
        inAppMessageRepository.getIAMData(OneSignal.appId, message.messageId, variantIdForMessage(message),
                new OSInAppMessageRepository.OSInAppMessageRequestResponse() {
                    ...
                    public void onFailure(String response) {
                        ...
                        try {
                            JSONObject jsonResponse = new JSONObject(response);
                            boolean retry = jsonResponse.getBoolean(OSInAppMessageRepository.IAM_DATA_RESPONSE_RETRY_KEY);
                            if (retry) {
